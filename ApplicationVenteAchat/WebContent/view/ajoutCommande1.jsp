    ...
    <div id="menu">
     ...
     <div id="advanced" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="advancedSort" aria-hidden="false" style="display: block;">
        <div class="modal-header">
            ...
            <h4>Veillez saisir le CIN du Client :</h4>
        </div>
                    ...
                    <div class="tab-pane active" id="CIN">
                        <form method="post" action="/ApplicationVenteAchat/RechercheClient">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <input type="hidden"  name="page" value="/view/ajoutCommande1.jsp">
                       ...
                       try{
                        	//client = (Client)request.getAttribute("resultat");
                        		...
                        		%>
                                 ...
                                 <td><form method="post" action="/ApplicationVenteAchat/AjoutCommande1"><input type="hidden"  value="<%= (Long)request.getAttribute("id")  %>"  name="code"><input type="submit" value="Ajouter Commande" class="btn btn-danger btn-xs"></form></td>
                             </tr>
