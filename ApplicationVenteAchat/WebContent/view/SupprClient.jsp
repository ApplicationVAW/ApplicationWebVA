                        ...
                        try{
                        	...
                        	for(Client client:liste){
                        		%>
                                 ...
                                 <td><form method="post" action="/ApplicationVenteAchat/SupprClient"><input type="text" hidden value="<%client.getCodeClient(); %>" name="code"><input type="submit" value="supprimer" class="btn btn-danger btn-xs"></form></td>
                             </tr>
